                ...
                <div class="collapse navbar-collapse justify-content-between">
                    ...
                    <ul class="navbar-nav header-right">
                        ...
                        <li class="nav-item dropdown header-profile">
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                <a href="<c:url value='/app-profile.html'/>" class="dropdown-item">
                                    <i class="icon-user"></i>
                                    <span class="ml-2">Profile </span>
                                </a>
                                <a href="<c:url value='/email-inbox.html'/>" class="dropdown-item">
...
<script src="<c:url value='/vendor/chartist/js/chartist.min.js'/>"></script>

<script src="<c:url value='/vendor/moment/moment.min.js'/>"></script>
<script src="<c:url value='/vendor/pg-calendar/js/pignose.calendar.min.js'/>"></script>
