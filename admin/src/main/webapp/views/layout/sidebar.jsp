...
<div class="quixnav">
    <div class="quixnav-scroll">
        <ul class="metismenu" id="menu">
            ...
            <li><a class="has-arrow" href="javascript:void()" aria-expanded="false"><i class="icon icon-user"></i><span
                    class="nav-text">고객 관리</span></a>
                <ul aria-expanded="false">
                    <li><a href="<c:url value='/customer-list'/>">고객 리스트</a></li>
                    <%--                    <li><a href="<c:url value='/customer-detail'/>">고객 상세</a></li>--%>
                </ul>
            </li>
            <li class="nav-label">채팅 관리</li>
            <li><a class="has-arrow" href="javascript:void()" aria-expanded="false"><i class="icon icon-user"></i><span
                    class="nav-text">채팅 관리</span></a>
                <ul aria-expanded="false">
                    <li><a href="<c:url value='/customer-chatlist'/>">채팅 리스트</a></li>
                    <%--                    <li><a href="<c:url value='/customer-detail'/>">고객 상세</a></li>--%>
                </ul>
            </li>
            <li class="nav-label">시니어 관리</li>
            <li><a class="has-arrow" href="javascript:void()" aria-expanded="false"><i
                    class="icon icon-user-female"></i><span class="nav-text">시니어 관리</span></a>
                <ul aria-expanded="false">
            ...
            <li><a class="has-arrow" href="javascript:void()" aria-expanded="false"><i
                    class="icon icon-people"></i><span class="nav-text">보호사 관리</span></a>
                <ul aria-expanded="false">
                    <li><a href="<c:url value='/careworker-list'/>">보호사 리스트</a></li>
                    <li><a href="<c:url value='/careworker-waitinglist'/>">보호사 승인 / 거절</a></li>
                    <%--                    <li><a href="<c:url value='/carewoker-certification'/>">보호사 자격증 상세</a></li>--%>
                </ul>
            </li>

            <li class="nav-label">공지 사항</li>
            <li><a class="has-arrow" href="javascript:void()" aria-expanded="false"><i class="icon icon-bell"></i><span
                    class="nav-text">공지 사항</span></a>
                <ul aria-expanded="false">
            ...
            <li><a class="has-arrow" href="javascript:void()" aria-expanded="false"><i
                    class="icon icon-question"></i><span class="nav-text">문의 관리</span></a>
                <ul aria-expanded="false">
