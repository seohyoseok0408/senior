    ...
    <div class="container-fluid">
      <nav class="navbar navbar-expand-lg custom_nav-container">
        ...
        <div class="user_option">
          <a class="active" href="index.html"> 홈 <span class="sr-only">(current)</span></a>
          <a class="" href="about.html"> 보호사 신청</a>
          <a class="" href="why.html"> 시니어 건강 </a>
          <a class="" href="team.html"> 일정 관리 </a>
          <a class="" href="testimonial.html"> 마이페이지</a>
          <a class="" href="contact.html"> 문의</a>
          <a href="">
              <span>로그인</span> <i class="fa fa-user" aria-hidden="true"></i>
          </a>
